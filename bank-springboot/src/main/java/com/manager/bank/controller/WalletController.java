...
public class WalletController {
    ...
    public ResponseEntity<ApiResponse<String>> withdraw(@RequestBody WithdrawRequest request, HttpServletRequest httpRequest) {
        ...
        createTransaction(userId, linkBank.getId(), wallet.getCurrency(), request.getAmount(), ENUM.TransactionType.WITHDRAW, descriptionWithdrawFromWallet);
        ...
        createTransaction(userId, null, wallet.getCurrency(), request.getAmount(), ENUM.TransactionType.WITHDRAW, descriptionDecreaBalance);
    ...
    public ResponseEntity<ApiResponse<String>> deposit(@RequestBody DepositRequest request, HttpServletRequest httpRequest) {
        ...
        createTransaction(userId, linkBank.getId(), wallet.getCurrency(), request.getAmount(), ENUM.TransactionType.DEPOSIT, descriptionDepositToWallet);   
        ...
        createTransaction(userId, null, wallet.getCurrency(), request.getAmount(), ENUM.TransactionType.DEPOSIT, descriptionIncreaseBalance);
    ...
    public ResponseEntity<ApiResponse<String>> transfer(@RequestBody TransferRequest request, HttpServletRequest httpRequest) {
        ...
        createTransaction(fromUserId, request.getToUserId(), fromWallet.getCurrency(), request.getAmount().toString(), ENUM.TransactionType.TRANSFER, descriptionTransfer);
        ...
        createTransaction(fromUserId, null, fromWallet.getCurrency(), request.getAmount().negate().toString(), ENUM.TransactionType.TRANSFER, descriptionDecreaBalance);
        ...
        createTransaction(request.getToUserId(), null, toWallet.getCurrency(), request.getAmount().toString(), ENUM.TransactionType.TRANSFER, descriptionIncreaseBalance);
    ...
    private void createTransaction(Integer fromUser, Integer toUser, String currency, String amount, ENUM.TransactionType type, String description) {
